...
V2_RUNNER_SCRIPT         = os.path.join(BASE_DIR, "phantomx_mvp", "live_stream_runner_v2.py")
V3_RUNNER_SCRIPT         = os.path.join(BASE_DIR, "phantomx_v3_universal_engine", "live_stream_runner_v3.py")
V2_REPORTER_SCRIPT       = os.path.join(BASE_DIR, "phantomx_mvp", "live_10min_reporter_v2.py")
V3_REPORTER_SCRIPT       = os.path.join(BASE_DIR, "phantomx_v3_universal_engine", "telemetry", "live_10min_reporter_v3.py")
...
def main():
    ...
    v2_cwd = os.path.join(BASE_DIR, "phantomx_mvp")
    ...
    v3_cwd = os.path.join(BASE_DIR, "phantomx_v3_universal_engine")
    ...
    # 5. Start V3 Reporter
    print("[5/5] Launching V3 Telemetry & Telegram Reporter...")
    v3_telemetry_cwd = os.path.join(BASE_DIR, "phantomx_v3_universal_engine", "telemetry")
    ...
    print("\n✅ All 5 processes running in parallel! Press Ctrl+C to terminate all.\n")
