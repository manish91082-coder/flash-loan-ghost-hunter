...
🚀 V2 Engine (Direct Spatial):
   Executes: {stats.v2_executes} | Profit: ${stats.v2_profit:.4f} USD
   Waits (Spread too low): {stats.v2_waits}

⚡ V3 Engine (Triangular Graph):
   Executes: {stats.v3_executes} | Profit: ${stats.v3_profit:.4f} USD
   Waits: {stats.v3_waits}

📡 Data Source: 100% LIVE On-Chain RPC
